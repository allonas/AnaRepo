...
public class InicioFragment extends ibmmobileappbuilder.ui.DetailFragment<Item>  {

    private Datasource<Item> datasource;
    private SearchOptions searchOptions;

    public static InicioFragment newInstance(Bundle args){
        InicioFragment card = new InicioFragment();
